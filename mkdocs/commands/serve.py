...
def _livereload(host, port, config, builder, site_dir, delay):
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
          theme_dir=None, livereload='livereload', wait=0, **kwargs):
    """
    ...
    try:
        ...
        if livereload in ['livereload', 'dirty']:
            _livereload(host, port, config, builder, site_dir, delay=wait)
        else:
